...
libraryDependencies ++= Seq(
  ...
  "oycii" % "streaming-kafka-connector_2.12" % "0.1",
  "oycii" % "streaming-json-validator_2.12" % "0.1",
  "oycii" % "streaming-avro-validator_2.12" % "0.1",
  "oycii" % "streaming-env-monitoring_2.12" % "0.1"
)
